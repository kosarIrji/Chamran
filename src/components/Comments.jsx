...
export default function Comments() {
  return (
    <section className="w-full mt-3">
      ...
      >
        <h3 className=" text-2xl    w-full flex flex-row-reverse aling-centeritems-center text-right justify-end gap-2  font-modam font-extrabold   text-[var(--text)] mb-2 leading-snug">
